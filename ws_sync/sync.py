...
async def ws_auth_user_session(ws: WebSocket, authorizer: Callable | None = None):
    '''
    A primitive WS user+session authentication protocol.
    ...
    try:
        ...
        if authorizer and not authorizer(user, session):
